...
class HsicXTestOutput(NamedTuple):
    stat: float
    pvalue: float
    dcorrx_dict: dict


class HsicX(TimeSeriesTest):
    r"""
    ...
    **kwargs
    ...
    def __init__(self, compute_kernel="gaussian", max_lag=0, **kwargs):
        ...
        TimeSeriesTest.__init__(self, compute_distance=None, max_lag=max_lag, **kwargs)
